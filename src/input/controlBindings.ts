...
import { ArrowUp, ChevronsUp, Shield, Footprints, Crosshair, GitBranch, Wind, Target, Sparkles, Zap, RefreshCw } from 'lucide-react';
export type InputDevice = 'keyboard' | 'xbox' | 'playstation' | 'touch';
export type GameAction = 'move' | 'sprint' | 'shield' | 'pass' | 'shoot' | 'through' | 'lob' | 'finesse' | 'chip' | 'skill' | 'tackle' | 'slide' | 'switch';
...
export const CONTROL_BINDINGS: ActionBinding[] = [
  ...
  { id: 'tackle', label: 'Tackle', icon: Zap, keyboard: ['T'], xbox: ['—'], playstation: ['—'], touch: '—' },
  { id: 'slide', label: 'Slide', icon: Zap, keyboard: ['X','Shift+T'], xbox: ['—'], playstation: ['—'], touch: '—' },
  { id: 'switch', label: 'Switch', icon: RefreshCw, keyboard: ['Tab'], xbox: ['—'], playstation: ['—'], touch: '—' },
];
